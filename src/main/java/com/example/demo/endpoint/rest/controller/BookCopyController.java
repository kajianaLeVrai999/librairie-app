...
public class BookCopyController {
  ...
  public ResponseEntity<?> createCopy(@PathVariable Integer bookId, @RequestBody BookCopyDTO dto) {

    try {

      return ResponseEntity.status(HttpStatus.CREATED).body(bookCopyService.create(bookId, dto));
  ...
  public ResponseEntity<List<BookCopyDTO>> getCopiesByBookId(@PathVariable Integer bookId) {
